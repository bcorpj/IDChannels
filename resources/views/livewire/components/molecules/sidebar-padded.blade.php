<div class="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0 pt-10 pl-6">
    <a href="#" class="mx-auto">
        <img class="w-auto h-6 sm:h-7" src="https://www.jusanmobile.kz//public/img/jusan_mobile_logo.png" alt="">
    </a>
    ...
    <div class="flex flex-col items-center mt-6 -mx-2">
        ...
        <h4 class="mx-2 mt-2 font-medium text-gray-800 dark:text-gray-200">{{ auth()->user()->fullname }}</h4>
        <p class="mx-2 mt-1 text-sm font-medium text-gray-600 dark:text-gray-400">{{ auth()->user()->login . '@' . auth()->user()->role() }}</p>
    </div>
...
{{--                    <x-include.molecules.sidebar-button-padded title="Team" icon="users" href="#" />--}}
